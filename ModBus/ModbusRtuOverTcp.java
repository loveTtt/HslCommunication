...
implements IModbus {
    ...
    private boolean crc16CheckEnable = true;
    ...
    public boolean isCrc16CheckEnable() {
        return this.crc16CheckEnable;
    }

    public void setCrc16CheckEnable(boolean crc16CheckEnable) {
        this.crc16CheckEnable = crc16CheckEnable;
    }
